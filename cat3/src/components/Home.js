			...
			<div>
				...
				<div className="showLastSession">
					...
					<div className="row">
						...
						<div className="top">
							...
							{!!localStorage.getItem('common') && (
								<a className="test-item global" href="/common">
									<ReactSVG src="./images/SVG/common.svg" />
								</a>
							)}

							{!!localStorage.getItem('memory') && (
								<a className="test-item global" href="/memory">
									<ReactSVG src="./images/SVG/memory.svg" />
								</a>
							)}
						</div>
				...
				<section className="psy-section" id="id1">
					<div className="container">
						<div className="board">
							<img id="bb" src="./images/bh.png" alt="" />
							<div className="row">
								...
								<div className="col-lg-7 item">
									<p>
										...
										aliquam dolore pariatur odit repellendus perspiciatis
										corrupti dolorem, porro est voluptatibus quo, eum unde rerum
										enim et animi nisi temporibus necessitatibus debitis! Quis
										molestias sint quaerat.
									</p>
								</div>
							</div>
						...
						<div className="cta">
							<div className="item-cta">
								<a className="psy-btn" href="#for-parent">
									Parents
								</a>
							</div>
							<div className="item-cta">
								<a className="psy-btn" href="#id2">
									Children
								</a>
							</div>
						</div>
					</div>
					<img className="f1 fish" src="./images/SVG/f1.svg" alt="" />
					<img className="f3 fish" src="./images/SVG/f3.svg" alt="" />
					<img className="f4 fish" src="./images/SVG/f3.svg" alt="" />
					<img className="f5 fish" src="./images/SVG/f5.svg" alt="" />
					<img className="b1 bubble" src="./images/SVG/b1.svg" alt="" />
					<img className="b2 bubble" src="./images/SVG/b1.svg" alt="" />
					<img className="b3 bubble" src="./images/SVG/b1.svg" alt="" />
					<img className="b4 bubble" src="./images/SVG/b1.svg" alt="" />
				</section>
						...
						<div className="row tn">
							<div className="col-lg-6 offset-lg-3">
								<h3>
									...
									Consectetur iste sunt explicabo? Doloremque, odio. Quos totam
									corrupti dignissimos? Consequuntur impedit quaerat non dolorum
									autem tenetur! Impedit deserunt dignissimos facilis odio.
								</h3>
							</div>
							<div className="col-lg-12">
								<div className="bigwhale">
									<a className="test-now psy-btn" href="#id4">
										<img src="./images/2x/whale.png" alt="" />
									</a>
									<div className="bg" />
								</div>
							</div>
					...
					<div className="container">
						...
						<div className="above-trynow">
							<p>
								...
								in itaque qui tempore minus ducimus magni, quam et consequatur
								cum sed exercitationem fugit iusto a quasi culpa, enim
								necessitatibus. Molestiae fuga, placeat quasi eum. Corporis,
								adipisci facilis in quod.
							</p>
