...
var link = ['', '', 'https://www.behance.net/latiosthin9651', '', '', 'https://facebook.com/thomas.4542', '', 'https://latiosthinh.github.io', 'project', '',''];
...
$(document).ready(function(){
    $("[href=project]").hover(() => { $('#project').addClass('open') })
    $('.close').click(() => { $('#project').removeClass('open') })
});
